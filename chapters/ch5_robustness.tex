...
\caption[Rolling 60-Month Pass-Through Estimates]{}
\label{fig:rolling}
\end{figure}
...
\caption[Residual Diagnostic Plots: Main ADL(3,3)]{}
\label{fig:residuals}
\end{figure}
...
\caption[Brent Crude Oil Price Regimes, 2004--2024]{}
\label{fig:regimes}
\end{figure}
...
\caption[CPT$^+$ vs.\ $|$CPT$^-|$ Across Specifications]{}
\label{fig:asymgap}
\end{figure}
