...
\begin{equation}
\Delta \ln \text{CPI}_t = \alpha + \gamma_1 \Delta \ln \text{CPI}_{t-1} + \beta_0 \Delta \ln \text{Oil}_t + \beta_1 \Delta \ln \text{Oil}_{t-1} + \delta \Delta \ln \text{IIP}_t + \mathbf{D}'\boldsymbol{\phi} + u_t
\label{eq:symmetric}
\end{equation}
...
\begin{equation}
\Delta \ln \text{CPI}_t = \alpha + \sum_{i=1}^{p} \gamma_i \Delta \ln \text{CPI}_{t-i} + \sum_{j=0}^{3} \pi^+_j \Delta \ln \text{Oil}^+_{t-j} + \sum_{j=0}^{3} \pi^-_j \Delta \ln \text{Oil}^-_{t-j} + \delta \Delta \ln \text{IIP}_t + \mathbf{D}'\boldsymbol{\phi} + u_t
\label{eq:asymmetric}
\end{equation}
...
\begin{equation}
\Delta \ln \text{CPI}_t = \alpha + \sum_{i=1}^{p} \gamma_i \Delta \ln \text{CPI}_{t-i} + \sum_{j=0}^{3} \pi^+_j \Delta \ln \text{Brent}^+_{t-j} + \sum_{j=0}^{3} \pi^-_j \Delta \ln \text{Brent}^-_{t-j} + \theta_0 \Delta \ln \text{EXR}_t + \theta_1 \Delta \ln \text{EXR}_{t-1} + \delta \Delta \ln \text{IIP}_t + \mathbf{D}'\boldsymbol{\phi} + u_t
\label{eq:brentexr}
\end{equation}
